    ...
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Activar dispositiu</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 bg-white p-6 sm:p-10 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="activationCode" className="text-sm font-bold text-foreground ml-1">
              Codi d&apos;activació
            </label>
            <input
              id="activationCode"
              ...
              maxLength={6}
              className="w-full px-4 py-4 rounded-xl bg-background border border-slate-200 text-foreground text-2xl font-black tracking-[0.3em] text-center placeholder-slate-300 placeholder-normal placeholder:text-base placeholder:tracking-normal placeholder:font-normal focus:outline-none focus:ring-2 focus:ring-success focus:border-transparent transition-all"
          ...
          <button
            ...
            className="w-full bg-success hover:bg-success/90 active:scale-[0.98] text-white font-bold text-xl py-4 rounded-2xl shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-success/30"
          >
