---
name: pathguard-workflow-sdd-validate
description: >-
  Procediment per validar una spec implementada. Carregar quan una spec està en estat `implementing` i es vol passar a `validated`. Use when: Spec implementada; Verificar AC abans de merge; QA sign-off.
