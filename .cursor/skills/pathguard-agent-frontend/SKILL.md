...
description: >-
  Rol: Agent Frontend (Next.js / PWA). Propietari de tota la capa TypeScript/React del projecte. Carregar quan la tasca afecta UI, components, routing, hooks, services o testing frontend. Use when: Qualsevol canvi a frontend/app/, components/, hooks/, services/, lib/; Decisions sobre UX, tokens Tailwind, accessibility; Tests Vitest nous o modificats.
---
...
- Veure `.cursor/skills/pathguard-domain-bridge-contract/SKILL.md`
...
- `.cursor/skills/pathguard-domain-bridge-contract/SKILL.md` (per a crides natives)
- `docs/guides/frontend.md` (si existeix)
