---
name: pathguard-workflow-sdd-review-spec
description: >-
  Procediment per revisar una spec SDD. Carregar quan el Tech Lead avalua una spec nova o modificada. Use when: Rebre spec per revisar; Decidir si aprovar/rebutjar.
