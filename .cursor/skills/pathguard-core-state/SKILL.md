---
name: pathguard-core-state
description: >-
  Retorna l'estat actual consolidat del projecte: branca, fase, spec activa, agent actiu, pròxima acció, bloquejos. Carregar A L'INICI DE TOTA SESSIÓ i abans de qualsevol canvi. Sense aquest skill no s'ha d'escriure codi. Use when: Inici de qualsevol sessió; Després d'una pausa llarga; Abans d'obrir una branca; Abans de fer un commit; Quan l'usuari diu "continua" o "on érem?".
---
