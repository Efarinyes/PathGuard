---
name: pathguard-domain-bridge-contract
description: >-
  Contracte TypeScript del bridge Capacitor LocationSync. La signatura és IMMUTABLE excepte canvis coordinats amb tots els agents nadius. Carregar abans de qualsevol canvi al bridge o als plugins nadius. Use when: Modificar frontend/plugins/location-sync/src/index.ts; Afegir mètode al plugin (iOS, Android); Modificar capacitor.config; Resoldre conflicte de signatura.
---
