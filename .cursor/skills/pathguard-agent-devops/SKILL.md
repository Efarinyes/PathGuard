...
description: >-
  Rol: Agent DevOps / Release. Propietari de CI/CD, secrets, observabilitat, builds i releases. Carregar quan una tasca afecta pipelines, entorns, observabilitat o deploys. Use when: Modificar .github/workflows/; Canviar env vars a Vercel/Render; Configurar secrets; Build d'APK/IPA; Crear tag/release.
---
