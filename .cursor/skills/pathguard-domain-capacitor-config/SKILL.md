---
name: pathguard-domain-capacitor-config
description: >-
  Configuració Capacitor (capacitor.config.ts, capacitor.config.json). Carregar quan es modifica la config nativa, URLs, plugins o webDir. Use when: Modificar capacitor.config.ts; Modificar frontend/ios/App/App/capacitor.config.json; Afegir plugin; Canviar appId o appName.
---
