...
description: >-
  Procediment per crear una nova spec SDD. Carregar quan s'inicia una feature, refactor, o canvi cross-capa. Use when: "vull afegir X"; "cal canviar Y"; Iniciar qualsevol tasca que toqui ≥2 capes.
...
- `.cursor/skills/pathguard-core-conventions/SKILL.md` (convencions)
- `.cursor/skills/pathguard-workflow-sdd-review-spec/SKILL.md` (següent pas)
