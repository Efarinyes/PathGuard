---
name: pathguard-workflow-branching
description: >-
  Convencions i procediment de branching. Carregar quan s'obre/modifica una branca o es planifica un release. Use when: Obrir branca; Planificar release; Decidir prefix.
