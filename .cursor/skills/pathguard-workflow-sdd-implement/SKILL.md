---
name: pathguard-workflow-sdd-implement
description: >-
  Procediment per implementar una spec aprovada. Carregar quan s'inicia la implementació d'una feature o refactor. Use when: Spec aprovada; Inici d'implementació; Obrir branca de feature.
