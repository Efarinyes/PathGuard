<!--
ARXIVAT — Aquest document és històric.

Aquest directori conté documents antics del projecte. **Només lectura.** No editar.
...
- **Mai** editar fitxers aquí.
- Si necessites actualitzar, crea un document nou a `../guides/`, `../phases/`, o un spec a `../../specs/`.
- Mantingues el `git log` per traçabilitat històrica.
