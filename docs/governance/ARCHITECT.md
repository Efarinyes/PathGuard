...
| **Coneixement operatiu** (`.cursor/skills/`) | Skills modulars per rol, domini i workflow | `.cursor/skills/<categoria>/<nom>/SKILL.md` | Tech Lead |
...
- **Nous agents**: afegir un nou rol requereix crear el seu skill a `.cursor/skills/`, actualitzar `agents/INDEX.md` i, si escau, definir-ne les responsabilitats a `MODEL_ROLES.md`.
