...
- `.opencode/skills/pathguard-domain-backend-stack/SKILL.md` (detall stack)
- `.opencode/skills/pathguard-backend-models/SKILL.md` (models, camps, regles)
- `.opencode/skills/pathguard-backend-ws-events/SKILL.md` (esquema WS events)
