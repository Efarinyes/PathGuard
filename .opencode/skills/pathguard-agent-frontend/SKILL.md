...
- Veure `.opencode/skills/pathguard-domain-bridge-contract/SKILL.md`
...
- `.opencode/skills/pathguard-domain-frontend-stack/SKILL.md` (detall stack)
- `.opencode/skills/pathguard-frontend-patterns/SKILL.md` (patrons comuns)
- `.opencode/skills/pathguard-domain-bridge-contract/SKILL.md` (per a crides natives)
