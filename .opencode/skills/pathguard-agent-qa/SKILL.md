...
Veure el procediment complet a `.opencode/skills/pathguard-domain-field-testing/SKILL.md`.
...
- `.opencode/skills/pathguard-domain-field-testing/SKILL.md` (procediment camp)
