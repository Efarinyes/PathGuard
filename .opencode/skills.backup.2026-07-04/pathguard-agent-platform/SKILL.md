...
- `.opencode/skills/pathguard-domain-bridge-contract/SKILL.md` (detall TS bridge)
- `.opencode/skills/pathguard-domain-capacitor-config/SKILL.md` (config patterns)
- `.opencode/skills/pathguard-agent-android/SKILL.md` (coordinació Android)
- `.opencode/skills/pathguard-agent-ios/SKILL.md` (coordinació iOS)
- `.opencode/skills/pathguard-agent-frontend/SKILL.md` (coordinació PWA)
