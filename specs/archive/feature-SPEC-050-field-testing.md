...
## 2. Context
El skill `.cursor/skills/pathguard-domain-field-testing/SKILL.md` ja defineix els 7 escenaris. Aquesta spec els **executa** i en documenta els resultats.
...
## 10. Referències
- `.cursor/skills/pathguard-domain-field-testing/SKILL.md` (procediment)
