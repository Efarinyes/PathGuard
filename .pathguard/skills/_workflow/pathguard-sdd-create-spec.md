---
name: pathguard-sdd-create-spec
description: |
...
- `.pathguard/skills/_core/pathguard-conventions.md` (convencions)
- `.pathguard/skills/_workflow/pathguard-sdd-review-spec.md` (següent pas)
